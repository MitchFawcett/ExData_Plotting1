## Generate Plot 3 for Exploratory Data Analysis Assignment 1
## By. M. Fawcett
## 06/05/2015
...
legend(x = "topright", lty = 1:1, col = c("black", "red", "blue"), legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
